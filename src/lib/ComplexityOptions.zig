...
const cyclomatic = @import("rules/complexity/cyclomatic.zig");
...
/// Maximum allowed cyclomatic complexity before a function is flagged.
cyclomatic_threshold: u32 = cyclomatic.default_threshold,
