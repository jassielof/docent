...
missing_doc_comment: severity.Level = rules.docs.missing_doc_comment.default_severity,
missing_doctest: severity.Level = rules.docs.missing_doctest.default_severity,
private_doctest: severity.Level = rules.docs.private_doctest.default_severity,
blank_doc_comment: severity.Level = rules.docs.blank_doc_comment.default_severity,
missing_summary_terminal_punctuation: severity.Level = rules.docs.missing_summary_terminal_punctuation.default_severity,
trailing_blank_doc_comment: severity.Level = rules.docs.trailing_blank_doc_comment.default_severity,
doctest_naming_mismatch: severity.Level = rules.docs.doctest_naming_mismatch.default_severity,
invalid_leading_phrase: severity.Level = rules.docs.invalid_leading_phrase.default_severity,
