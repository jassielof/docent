...
test "detects missing terminal punctuation on /// comment" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"missing_summary_terminal_punctuation.zig"},
        warn,
        .{},
        null,
    );
...
test "well-punctuated summary is clean" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"summary_terminal_punctuation_ok.zig"},
        warn,
        .{},
        null,
    );
...
test "accepts exclamation and question marks" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"missing_summary_exclamation_question_ok.zig"},
        warn,
        .{},
        null,
    );
...
test "only first paragraph is checked" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"missing_summary_second_paragraph_ok.zig"},
        warn,
        .{},
        null,
    );
...
test "multiline summary within first paragraph" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"missing_summary_multiline_no_punct.zig"},
        warn,
        .{},
        null,
    );
...
test "multiline summary with punctuation is clean" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"missing_summary_multiline_ok.zig"},
        warn,
        .{},
        null,
    );
...
test "detects missing punctuation on //! module doc" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"missing_summary_module_no_punct.zig"},
        warn,
        .{},
        "root.zig",
    );
...
test "enum member summary punctuation" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"missing_summary_enum_enumerator.zig"},
        warn,
        .{},
        null,
    );
