...
test "detects trailing blank /// line" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"trailing_blank_doc_comment.zig"},
        warn,
        .{},
        null,
    );
...
test "detects multiple trailing blank /// lines once" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"trailing_blank_multiple_lines.zig"},
        warn,
        .{},
        null,
    );
...
test "no diagnostic when block ends with content" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"trailing_blank_content_end_ok.zig"},
        warn,
        .{},
        null,
    );
...
test "no diagnostic for fully blank block" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"trailing_blank_fully_blank_ok.zig"},
        warn,
        .{},
        null,
    );
...
test "detects trailing blank /// on enum enumerator" {
    var result = try harness.lintRuleFixtureDisplay(
        ns,
        &.{"trailing_blank_enum_enumerator.zig"},
        warn,
        .{},
        null,
    );
